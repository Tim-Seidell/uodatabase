        ...
        <div class = "row">
            <div class = "col-md text-center">
                ...
                <form action="includes/addTable.inc.php" method="POST">
                    ...
                    <button type="submit" class="button button_blue" name = "newItem" value = "newItem" style = "width: 230px;">Create New Item</button>
                </form>
            </div>
            ...
            <div class = "col-md text-center">
                ...
                <form action="includes/addTable.inc.php" method="POST">
                    ...
                    <button type="submit" class="button button_blue" name = "newUniform" value = "newUniform" style = "width: 230px;">Create New Uniform</button>
                </form>
            </div>
